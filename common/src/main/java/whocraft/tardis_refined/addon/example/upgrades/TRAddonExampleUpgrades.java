...
public class TRAddonExampleUpgrades {
    ...
    // Base Upgrades
    public static final RegistrySupplier<Upgrade> TELEPORTATION = Upgrades.UPGRADE_DEFERRED_REGISTRY.register("teleportation", () ->
    ...
    public static final RegistrySupplier<Upgrade> HOLOGRAPHIC_DISGUISE = Upgrades.UPGRADE_DEFERRED_REGISTRY.register("holographic_disguise", () ->
    ...
    // Defense Upgrades
    public static final RegistrySupplier<Upgrade> FORCE_FIELD_GENERATOR = Upgrades.UPGRADE_DEFERRED_REGISTRY.register("force_field_generator", () ->
    ...
    // Navigation Upgrades
    public static final RegistrySupplier<Upgrade> WORMHOLE_JUMP = Upgrades.UPGRADE_DEFERRED_REGISTRY.register("wormhole_jump", () ->
    ...
    // In your dreams
    public static final RegistrySupplier<Upgrade> TIME_TRAVEL = Upgrades.UPGRADE_DEFERRED_REGISTRY.register("time_travel", () ->
